...
const UserInventoryPage = ({ username, userId }) => {
  ...
  const ogUrl = userId ? `http://localhost:5000/users/${userId}/inventory` : '';
    ...
    <>
      {username && (
        <Head>
          ...
          <meta property="og:image" content={`http://localhost:5000/thumbs/avatar-headshot.ashx?userId=${userId}`} />
