...
local THUMBNAIL_URL = "http://localhost:5000/Thumbs/Avatar.ashx?x=200&y=200&format=png&userId="
local BUST_THUMBNAIL_URL = "http://localhost:5000/bust-thumbnail/image?width=420&height=420&format=png&userId="
